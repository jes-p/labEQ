"""Module for managing Green's functions produced by PlateSoln matlab code."""
import matlab.engine
import h5py
import numpy as np
from os.path import exists as path_exists

def get_greens(dist_dict, post_len, pre=200, vp=2.74, vs=1.4, dist_prec=2, source_type='moment',path = '/home/jes/data/Lab_Data/BP3_GF/PlateSoln',verbose=1):
...
def get_raytime(dist, post_len, pre=200, vp=2.74, vs=1.4, dist_prec=2, source_type='moment', path = '/home/jes/data/Lab_Data/BP3_GF/PlateSoln', verbose=1):
...
def calc_greens(dist_list: list, post_len, vp=2.74, vs=1.4, dist_prec=2, source_type='moment',path = '/home/jes/data/Lab_Data/BP3_GF/PlateSoln',verbose=1):
...
def check_for_green(dist, post_len, dist_prec=2, source_type='moment',path = '/home/jes/data/Lab_Data/BP3_GF/PlateSoln'):
